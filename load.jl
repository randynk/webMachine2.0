...
for i in 1:nbre_rub
    ...
    global head = string(head, """<button class="rubrique"><a href="index.html#rub-$i">$(rubrique[i])</a></button>\n""")
    for j in 1:nbre_sous_rubrique[i]
